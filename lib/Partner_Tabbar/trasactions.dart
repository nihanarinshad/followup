...
class PartnerTransaction extends StatefulWidget {
  const PartnerTransaction({super.key});

  @override
  State<PartnerTransaction> createState() => _TenantTransactionState();
}

class _TenantTransactionState extends State<PartnerTransaction> {
