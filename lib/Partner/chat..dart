...
class PartnerChat extends StatefulWidget {
  const PartnerChat({Key? key});

  @override
  State<PartnerChat> createState() => _EnquryChatScreenState();
}

class _EnquryChatScreenState extends State<PartnerChat> {
